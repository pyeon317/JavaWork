...
public class MainClass03 {
	...
	public static void main(String[] args) {
		...
		System.out.println(newList.toString()); //tolist list로 반환
		
		
		Set<Integer> newList2 = list.stream().filter( a -> a % 3 == 0).collect(Collectors.toSet());
		System.out.println(newList2.toString()); //setlist set로 반환
		...
		//DoubleStream
		//LongStream
		IntStream.range(1, 10).forEach( a -> System.out.println(a) );//intstream 가장 많이 사용 //미만까지 정수스트림 반환 1~9
		IntStream.rangeClosed(1, 10).forEach(a -> System.out.println(a) ); //포함 정수스트림 반환 1~10
