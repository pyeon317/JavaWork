...
public class FileQuiz02 {
	...
	public static void main(String[] args) {
		 ...
		 /*
	      * 1. Date클래스를 이용해서 File경로에 하위폴더로 yyyy mm dd file 폴더를 생성합니다
		...
		String filepath = "C:\\Users\\user\\Desktop\\file\\"+ now + "file"; //경로
		...
		try(BufferedWriter bw = new BufferedWriter(new FileWriter(path));
			BufferedReader br = new BufferedReader(new FileReader(path));  ) { //파일 만들기
